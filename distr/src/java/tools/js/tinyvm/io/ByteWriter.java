 ...
 * 
 * This writes bytecode out to a binary file. It is the original implementation
 * from TinyVM; in b2fJ this is replaces by CCodeWriter that generates C code
 * directly.
 * 
 * Left here together with BEByteWriter & LEByteWriter in case it is needed
 * again.
 */
